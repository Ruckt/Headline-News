...
@implementation ArticleDataStore
...
+ (ArticleDataStore *)sharedArticleDataStore {
    static ArticleDataStore *_sharedArticleDataStore = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedArticleDataStore = [[ArticleDataStore alloc] init];
    });
    
    return _sharedArticleDataStore;
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ruckt.HeadlineNews" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"HeadlineNews" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"HeadlineNews.sqlite"];
    NSError *error = nil;
